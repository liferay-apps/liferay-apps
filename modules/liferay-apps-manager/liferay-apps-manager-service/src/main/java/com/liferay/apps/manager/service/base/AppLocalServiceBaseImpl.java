...
package com.liferay.apps.manager.service.base;

import com.liferay.apps.manager.model.App;
import com.liferay.apps.manager.service.AppLocalService;
import com.liferay.apps.manager.service.AppLocalServiceUtil;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.apps.manager.service.impl.AppLocalServiceImpl}.
 * </p>
 *
 * @author LifeDev
 * @see com.liferay.apps.manager.service.impl.AppLocalServiceImpl
 * @generated
 */
public abstract class AppLocalServiceBaseImpl
	...
	public App fetchAppByUuidAndGroupId(String uuid, long groupId) {
		return appPersistence.fetchByUUID_G(uuid, groupId);
	}
					...
					if (portletDataContext.isInitialPublication()) {
						...
						StagedModelDataHandler<?> stagedModelDataHandler =
							StagedModelDataHandlerRegistryUtil.
								getStagedModelDataHandler(App.class.getName());
	...
	public List<App> getAppsByUuidAndCompanyId(String uuid, long companyId) {
		return appPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<App> getAppsByUuidAndCompanyId(
		...
		return appPersistence.findByUuid_C(
	...
	public App getAppByUuidAndGroupId(String uuid, long groupId)
		...
		return appPersistence.findByUUID_G(uuid, groupId);
	}
