...
public class AppModelArgumentsResolver implements ArgumentsResolver {
	...
	public Object[] getArguments(
		...
		if (finderPathColumnBitmask == null) {
			...
			if (finderPath.isBaseModelResult() &&
				(AppPersistenceImpl.FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION ==
	...
	static {
		...
		orderByColumnsBitmask |= AppModelImpl.getColumnBitmask("groupId");
		orderByColumnsBitmask |= AppModelImpl.getColumnBitmask("name");
